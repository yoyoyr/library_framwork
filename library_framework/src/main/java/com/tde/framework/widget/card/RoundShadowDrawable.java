...
class RoundShadowDrawable extends Drawable {
    /**
    ...
    RoundShadowDrawable(Resources resources, ColorStateList backgroundColor, float radius,
    ...
    public void draw(Canvas canvas) {
        ...
        drawShadow(canvas);
        canvas.translate(0, -mRawShadowSize / 2);
        RoundRectHelper.drawRoundRect(canvas, mCardBounds, mCornerRadius, mPaint);
    }
